...
gsub(temp$Description,pattern = "a_cp_",replacement = "") -> temp$Description
...
gsub(temp2$Description,pattern = "a_cp_",replacement = "") -> temp2$Description
...
ggplot(temp3,aes(x = Description,
              ...
              geom_bar(stat = "identity", position = position_dodge()) + coord_flip() -> pole_p2


pole_p2 + facet_grid(. ~ cluster) -> pole_p2
